"""
Django settings for project_piggy project.
...
SECRET_KEY = 'l8c_&9$*=9qx_w$6d=9wudu1@%n%%9%ku^s%3)y8*9eu(_rr&g'
...
ROOT_URLCONF = 'project_piggy.urls'
...
WSGI_APPLICATION = 'project_piggy.wsgi.application'
